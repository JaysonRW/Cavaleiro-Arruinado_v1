    ...
    loreNotes: [
      {
        x: 120,
        y: 380,
        title: 'Pergaminho do Eremita do Sal:',
        lines: [
          '«O aço dos mortais corta apenas carne e osso; fantasmas o ignoram.»',
          '«Fale com Frei Anselmo [E] para receber sal e bênçãos das almas.»',
        ],
      },
      {
        x: 1380,
        y: 390,
        title: 'Manuscrito das Ameias do Monastério:',
        lines: [
          '«Avance para a borda direita para adentrar a Floresta Corrompida.»',
          '«Cuidado com as raízes negras e os carniçais escondidos na névoa.»',
        ],
      },
    ],
    edgeTriggers: [
    ...
    loreNotes: [
      {
        x: 260,
        y: 380,
        title: 'Anotações do Caçador Perdido:',
        lines: [
          '«As árvores sussurram com as almas dos que tombaram na praga.»',
          '«A carne podre dos carniçais sucumbe ao corte comum do aço!»',
          '«Guarde tuas unções de sal para os espectros alados da copa.»',
        ],
      },
      {
        x: 1820,
        y: 390,
        title: 'Placa de Ferro Cravada na Casca:',
        lines: [
          '«« À esquerda: Retorno ao Pátio do Monastério.»',
          '« À direita: Desça para a Cripta Esquecida dos Mártires.»',
        ],
      },
    ],
    edgeTriggers: [
    ...
    loreNotes: [
      {
        x: 280,
        y: 380,
        title: 'Epitáfio dos Mártires de Ferro:',
        lines: [
          '«Aqui jaz a Primeira Guarda do Cálice de Sal.»',
          '«Suas almas aprisionadas clamam por banimento sagrado.»',
          '«Ascenda tua alma com almas colhidas para romper as correntes.»',
        ],
      },
      {
        x: 2020,
        y: 390,
        title: 'Inscrição no Selo do Abismo:',
        lines: [
          '«Tu alcançaste os confins mais profundos da Cripta Esquecida.»',
          '«A névoa etérea se dispersa sob a glória da tua espada consagrada!»',
        ],
      },
    ],
    edgeTriggers: [
