...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-[#E5D7B5] text-[#0A2570] font-serif flex flex-col items-center py-4 px-2 sm:px-6 selection:bg-[#0A2570] selection:text-[#F4ECD8]">
      {/* Folha de Caderno / Manuscrito Antigo Container */}
      <div className="w-full max-w-5xl bg-[#F4ECD8] shadow-2xl rounded-xl border-4 border-[#0A2570] p-4 sm:p-8 relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 text-[11px] font-bold uppercase tracking-wider bg-[#0A2570] text-[#F4ECD8] rounded">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`px-3 py-1.5 rounded font-['Cinzel'] text-xs font-bold transition-all cursor-pointer border ${
                  activeTab === 'game'
                    ? 'bg-[#0A2570] text-[#F4ECD8] border-[#0A2570] shadow-sm'
                    : 'bg-[#F4ECD8] text-[#0A2570] border-[#0A2570]/30 hover:bg-[#0A2570]/10'
                }`}
              >
                Cena Jogável
              </button>
        ...
        <div className="pl-2 sm:pl-6">
          {activeTab === 'game' && (
            <div className="flex flex-col items-center">
              ...
              <div className="w-full mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                <div className="p-3 bg-[#EFE5CA] border border-[#0A2570]/25 rounded">
          ...
          {activeTab === 'design' && (
            <div className="py-2 space-y-6 text-sm">
              <section className="bg-[#EFE5CA] p-5 rounded-lg border border-[#0A2570]/30">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 bg-[#F4ECD8] rounded border-2 border-[#10B981]/40">
                  ...
                  <div className="p-4 bg-[#F4ECD8] rounded border-2 border-[#C81E1E]/40">
                  ...
                  <div className="p-4 bg-[#F4ECD8] rounded border-2 border-[#F59E0B]/40">
              ...
              <section className="bg-[#EFE5CA] p-5 rounded-lg border border-[#0A2570]/30">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                  <div className="p-3 bg-[#0A2570] text-[#F4ECD8] rounded flex flex-col justify-between">
                    <span className="font-bold">Caneta Azul Escuro</span>
                    <span className="font-mono text-[10px] opacity-80">#0A2570 (Traços Base)</span>
                  </div>
                  <div className="p-3 bg-[#F4ECD8] border border-[#0A2570] text-[#0A2570] rounded flex flex-col justify-between">
                    <span className="font-bold">Papel Pergaminho</span>
                    <span className="font-mono text-[10px] opacity-80">#F4ECD8 (Fundo)</span>
                  </div>
