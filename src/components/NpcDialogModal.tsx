...
export const NpcDialogModal: React.FC<NpcDialogModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in duration-150">
      <div className="relative w-full max-w-xl bg-[#F4ECD8] border-4 border-[#0A2570] rounded-lg shadow-2xl p-5 md:p-6 font-serif select-none">
        ...
        <div className="flex items-center gap-3 border-b-2 border-[#0A2570]/20 pb-3 pl-4">
          <div className="w-11 h-11 rounded-full bg-[#E8DCB8] border-2 border-[#0A2570] flex items-center justify-center text-[#0A2570] shadow-sm">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-3.5 py-2.5 rounded border text-sm font-medium transition-all flex items-center justify-between ${
                    canAfford
                      ? 'bg-[#EFE4C8] hover:bg-[#E4D5B3] text-[#0A2570] border-[#0A2570]/40 shadow-xs cursor-pointer'
