...
export const GameIntro: React.FC<GameIntroProps> = ({ onStartGame }) => {
  ...
  return (
    <div className="w-full min-h-[580px] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl bg-[#F4ECD8] border-4 border-[#0A2570] rounded-lg shadow-2xl p-6 md:p-8 font-serif select-none overflow-hidden">
        ...
        {mode === 'COVER' ? (
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center py-8 space-y-6">
            <div className="w-16 h-16 rounded-full border-2 border-[#0A2570] flex items-center justify-center bg-[#E8DCB8]/60 shadow-inner">
            ...
            <div className="w-full max-w-md p-4 bg-[#EADBB8]/40 border border-[#0A2570]/30 rounded-md">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              ...
              <button
                ...
                onClick={handleSkip}
                className="px-5 py-3 bg-[#E8DCB8] hover:bg-[#DFCFA3] text-[#0A2570] font-['Cinzel'] font-bold rounded border-2 border-[#0A2570]/40 flex items-center gap-2 transition-all cursor-pointer"
              >
