...
export const GameCanvas: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center select-none">
      ...
      <div className="w-full max-w-5xl flex flex-wrap items-center justify-between gap-3 px-4 py-2 text-xs font-serif text-[#0A2570] border-b border-[#0A2570]/20 bg-[#F4ECD8]/90">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded flex items-center gap-1.5 transition-colors cursor-pointer border ${
              showGddGuide
                ? 'bg-[#0A2570] text-[#F4ECD8] border-[#0A2570]'
      ...
      {showGddGuide && (
        <div className="w-full max-w-5xl px-4 py-3 bg-[#EFE4C8] border-b-2 border-[#0A2570]/30 text-xs font-serif text-[#051442] animate-in fade-in duration-200">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="p-2.5 bg-[#F4ECD8] rounded border border-[#0A2570]/20">
      ...
      <div className="relative w-full max-w-5xl my-2 p-2 sm:p-4 bg-[#EADBB8] shadow-2xl rounded-lg border-2 border-[#0A2570]/30">
        ...
        <div className="w-full flex flex-col gap-2 px-3 py-2 bg-[#F4ECD8]/95 border-2 border-[#0A2570] rounded-t-md font-serif">
          {/* Barra de Progresso de 'Ascensão' no topo da tela */}
          <div className="w-full flex flex-wrap items-center justify-between gap-2.5 px-3 py-2 bg-[#EADBB8]/60 border border-[#0A2570]/30 rounded shadow-xs">
            ...
            <div className="flex-1 min-w-[220px] max-w-md mx-2 flex flex-col gap-0.5">
              ...
              <div className="w-full h-3.5 bg-[#DED1AA] border border-[#0A2570] rounded-xs overflow-hidden p-0.5 relative shadow-inner">
                <div
          ...
          <div className="w-full flex flex-wrap items-center justify-between gap-2 px-3 py-1.5 bg-[#E8DCB8]/50 border border-[#0A2570]/25 rounded text-xs">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-[#0A2570]" />
              <span className="font-bold text-[#0A2570] font-['Cinzel'] tracking-wide">
                SEÇÃO ATIVA:
              </span>
              <span className="px-2 py-0.5 rounded bg-[#0A2570] text-[#F4ECD8] text-[11px] font-semibold tracking-wide">
                ...
                return (
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[11px] font-serif transition-colors cursor-pointer border ${
                      isActive
                        ? 'bg-[#0A2570] text-[#F4ECD8] border-[#0A2570] font-bold shadow-xs'
                        : 'bg-[#F4ECD8]/80 text-[#0A2570] border-[#0A2570]/30 hover:bg-[#0A2570]/15'
                    }`}
          ...
          <div className="w-full flex flex-wrap items-center justify-between gap-3 pt-0.5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <div className="w-32 sm:w-44 h-3.5 bg-[#E8DCB8] border border-[#0A2570] rounded-xs overflow-hidden p-0.5">
                  <div
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <div className="w-24 sm:w-32 h-3.5 bg-[#E8DCB8] border border-[#0A2570] rounded-xs overflow-hidden p-0.5">
                  <div
              ...
              <button
                ...
                className={`px-3 py-1 rounded border-2 flex items-center gap-1.5 text-xs font-bold transition-all cursor-pointer ${
                  stats.hasSaltWeapon
                    ...
                    : stats.saltCount > 0
                    ? 'bg-[#0A2570] hover:bg-[#143D99] text-[#F4ECD8] border-[#051442] shadow-sm'
        ...
        <div className="relative w-full aspect-video bg-[#F4ECD8] overflow-hidden border-2 border-t-0 border-[#0A2570]">
          <canvas
            ref={canvasRef}
          ...
          {showRespawnBanner && (
            <div className="absolute inset-0 bg-[#051442]/85 flex flex-col items-center justify-center text-[#F4ECD8] z-30 animate-in fade-in duration-300">
              <h2 className="text-3xl sm:text-4xl font-black font-['Cinzel'] text-[#C81E1E] mb-2 tracking-widest">
                SUA ALMA FOI CONSUMIDA
              </h2>
              <p className="text-sm sm:text-base font-serif italic text-[#F4ECD8]/80 mb-6 text-center max-w-md px-4">
                «A maldição não perdoa o cavaleiro imprudente. Levante-se e use as ferramentas de exorcismo corretas.»
              </p>
              <button
                id="btn-respawn"
                onClick={handleReset}
                className="px-6 py-2.5 bg-[#C81E1E] hover:bg-[#DC2626] text-[#F4ECD8] font-bold rounded font-serif border-2 border-[#F4ECD8] tracking-wider transition-transform hover:scale-105 cursor-pointer shadow-lg"
              >
        ...
        <div className="w-full mt-2 p-2 bg-[#F4ECD8]/95 border-2 border-[#0A2570] rounded-b-md flex flex-wrap items-center justify-between gap-2 text-xs font-serif text-[#0A2570]">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            <span className="font-bold flex items-center gap-1">
              <Info className="w-3.5 h-3.5" />
              Comandos:
            </span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">A / D</kbd> Andar</span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">Espaço</kbd> Pular (2x: Giro 360°)</span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">J</kbd> Espada</span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">Shift</kbd> Rolamento</span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">Q</kbd> Imbuir Sal</span>
            <span><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0A2570] rounded text-[10px] font-mono">E</kbd> Altar / Falar com NPC</span>
            <span className="text-[#0284C7] font-semibold"><kbd className="px-1.5 py-0.5 bg-[#E8DCB8] border border-[#0284C7] rounded text-[10px] font-mono">Bordas da Tela</kbd> Transitar Seções</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:hidden">
            <button
              ...
              className="p-2 bg-[#0A2570] text-[#F4ECD8] rounded active:scale-95"
            >
              ◀
            </button>
            <button
            ...
            <button
              ...
              className="px-3 py-2 bg-[#0A2570] text-[#F4ECD8] rounded font-bold active:scale-95"
            >
              Pulo
            </button>
            <button
              ...
              className="px-3 py-2 bg-[#C81E1E] text-[#F4ECD8] rounded font-bold active:scale-95"
            >
              Atacar
            </button>
            <button
        ...
        <div className="fixed inset-0 z-50 bg-[#051442]/80 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 animate-in fade-in duration-200">
          <div className="relative w-full max-w-3xl">
            <button
              ...
              className="absolute top-3 right-3 z-30 px-3 py-1 bg-[#C81E1E] hover:bg-[#B91C1C] text-[#F4ECD8] rounded font-bold text-xs border border-[#F4ECD8] cursor-pointer shadow-md transition-colors"
            >
              Fechar [✕]
            </button>
